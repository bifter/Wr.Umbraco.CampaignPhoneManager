...
{
    /// <summary>
    /// A class to test xpath logic using test xml data based on a hardcoded copy of /App_Data/umbraco.config
    /// </summary>
    public class XPathDataSource_TestXml : IXPathDataSource
    {
        public DefaultSettings LoadDefaultSettings(string xpath)
        {
            DefaultSettings result = new DefaultSettings();
            xpath = UpdateXpathForTesting(xpath);

            XmlDocument doc = new XmlDocument();
            doc.LoadXml(GetTestUmbracoContentXml());
        ...
        /// <returns></returns>
        private string UpdateXpathForTesting(string xpath)
        {
        ...
        /// <returns></returns>
        private List<PhoneNumber> ConvertXmlToModel(XmlNodeList content)
        {
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        private PhoneNumber ConvertXmlToModel(XmlNode content)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private string GetTestUmbracoContentXml()
        {
...
<root id=""-1"">
  ...
  ""position"": {
    ...
    <phoneManager id=""1152"" key=""ee64b6fe-21dc-445c-9256-1d5497f91383"" parentID=""1103"" level=""2"" creatorID=""0"" sortOrder=""5"" createDate=""2017-11-13T12:20:43"" updateDate=""2017-11-27T17:38:26"" nodeName=""Phone manager"" urlName=""phone-manager"" path=""-1,1103,1152"" isDoc="""" nodeType=""1151"" creatorName=""Joe Bloggs"" writerName=""Joe Bloggs"" writerID=""0"" template=""0"" nodeTypeAlias=""phoneManager"">
      ...
      <defaultCampaignQuerystringKey><![CDATA[fsource]]></defaultCampaignQuerystringKey>
