...
namespace Wr.UmbracoPhoneManager.Tests.Data
{
    [TestClass]
    public class XPathDataProviderTest
    {
        ...
        public void LoadDefaultSettingsTest()
        {
            ...
            doc.LoadXml(GetUmbracoContentXml());

            var content = doc.SelectSingleNode("//ancestor-or-self::home[position()=1]//phoneManager");// ("ancestor::home[position()=1]//phoneManager");
            Assert.IsTrue(content != null);

            var phoneNumber = content.SelectSingleNode("defaultPhoneNumber");
            Assert.IsTrue(phoneNumber != null);

            Assert.IsTrue(phoneNumber.InnerText == "0800 000 0001");
            
        }

        [TestMethod]
        public void GetCampaignCodeRecordMatchingQsValueTest()
        {

            XmlDocument doc = new XmlDocument();
            doc.LoadXml(GetUmbracoContentXml());

            var xpath = string.Format("//ancestor-or-self::home[position()=1]//phoneManager/phoneNumber[campaignCode!='']");
            var content = doc.SelectSingleNode(xpath);
            Assert.IsTrue(content != null);

            var phoneNumber = content.SelectSingleNode("phoneNumber");
            Assert.IsTrue(phoneNumber != null);

            Assert.IsTrue(phoneNumber.InnerText == "0800 123 4567");
        }


        private string GetUmbracoContentXml()
        {
...
<root id=""-1"">
  ...
  ""position"": {
    ...
    <phoneManager id=""1152"" key=""ee64b6fe-21dc-445c-9256-1d5497f91383"" parentID=""1103"" level=""2"" creatorID=""0"" sortOrder=""5"" createDate=""2017-11-13T12:20:43"" updateDate=""2017-11-27T17:38:26"" nodeName=""Phone manager"" urlName=""phone-manager"" path=""-1,1103,1152"" isDoc="""" nodeType=""1151"" creatorName=""Joe Bloggs"" writerName=""Joe Bloggs"" writerID=""0"" template=""0"" nodeTypeAlias=""phoneManager"">
      <defaultPhoneNumber><![CDATA[0800 000 0001]]></defaultPhoneNumber>
      <campaignQuerystring><![CDATA[fsource]]></campaignQuerystring>
      <phoneNumber id=""1201"" key=""8b0d2b79-f219-47c0-9c44-a6dc96204534"" parentID=""1152"" level=""3"" creatorID=""0"" sortOrder=""0"" createDate=""2017-11-27T17:37:57"" updateDate=""2017-11-27T17:37:57"" nodeName=""Test number"" urlName=""test-number"" path=""-1,1103,1152,1201"" isDoc="""" nodeType=""1150"" creatorName=""Joe Bloggs"" writerName=""Joe Bloggs"" writerID=""0"" template=""0"" nodeTypeAlias=""phoneNumber"">
        <internalCode><![CDATA[intcode]]></internalCode>
        <overwritePersistingNumber>0</overwritePersistingNumber>
        <persist>0</persist>
        <phoneNumber><![CDATA[0800 123 4567]]></phoneNumber>
        <campaignCode><![CDATA[testcode]]></campaignCode>
      </phoneNumber>
        <phoneNumber id=""1202"" key=""9b0d2b79-f219-47c0-9c44-a6dc96204534"" parentID=""1152"" level=""3"" creatorID=""0"" sortOrder=""0"" createDate=""2017-11-27T17:37:57"" updateDate=""2017-11-27T17:37:57"" nodeName=""Test number"" urlName=""test-number"" path=""-1,1103,1152,1201"" isDoc="""" nodeType=""1150"" creatorName=""Joe Bloggs"" writerName=""Joe Bloggs"" writerID=""0"" template=""0"" nodeTypeAlias=""phoneNumber"">
        <internalCode></internalCode>
        <overwritePersistingNumber>0</overwritePersistingNumber>
        <persist>0</persist>
        <phoneNumber><![CDATA[0800 222 22222]]></phoneNumber>
